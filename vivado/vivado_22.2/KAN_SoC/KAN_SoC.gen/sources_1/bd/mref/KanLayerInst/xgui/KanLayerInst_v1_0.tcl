...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "BRAM_CTRL_ADDR" -parent ${Page_0}
  ipgui::add_param $IPINST -name "BRAM_CTRL_WE" -parent ${Page_0}
  ipgui::add_param $IPINST -name "BRAM_CTRL_WIDTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.BRAM_CTRL_ADDR { PARAM_VALUE.BRAM_CTRL_ADDR } {
	# Procedure called to update BRAM_CTRL_ADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BRAM_CTRL_ADDR { PARAM_VALUE.BRAM_CTRL_ADDR } {
	# Procedure called to validate BRAM_CTRL_ADDR
	return true
}

proc update_PARAM_VALUE.BRAM_CTRL_WE { PARAM_VALUE.BRAM_CTRL_WE } {
	# Procedure called to update BRAM_CTRL_WE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BRAM_CTRL_WE { PARAM_VALUE.BRAM_CTRL_WE } {
	# Procedure called to validate BRAM_CTRL_WE
	return true
}

proc update_PARAM_VALUE.BRAM_CTRL_WIDTH { PARAM_VALUE.BRAM_CTRL_WIDTH } {
	# Procedure called to update BRAM_CTRL_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BRAM_CTRL_WIDTH { PARAM_VALUE.BRAM_CTRL_WIDTH } {
	# Procedure called to validate BRAM_CTRL_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.BRAM_CTRL_WIDTH { MODELPARAM_VALUE.BRAM_CTRL_WIDTH PARAM_VALUE.BRAM_CTRL_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BRAM_CTRL_WIDTH}] ${MODELPARAM_VALUE.BRAM_CTRL_WIDTH}
}

proc update_MODELPARAM_VALUE.BRAM_CTRL_WE { MODELPARAM_VALUE.BRAM_CTRL_WE PARAM_VALUE.BRAM_CTRL_WE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BRAM_CTRL_WE}] ${MODELPARAM_VALUE.BRAM_CTRL_WE}
}

proc update_MODELPARAM_VALUE.BRAM_CTRL_ADDR { MODELPARAM_VALUE.BRAM_CTRL_ADDR PARAM_VALUE.BRAM_CTRL_ADDR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BRAM_CTRL_ADDR}] ${MODELPARAM_VALUE.BRAM_CTRL_ADDR}
}
