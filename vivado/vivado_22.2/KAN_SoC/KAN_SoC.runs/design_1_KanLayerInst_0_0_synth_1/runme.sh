...
HD_PWD='D:/Yannos/FILES/PROGRAMS/FPGA/SoC/KAN/gvenit_design/kan-fpga/vivado/vivado_22.2/KAN_SoC/KAN_SoC.runs/design_1_KanLayerInst_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_KanLayerInst_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_KanLayerInst_0_0.tcl
