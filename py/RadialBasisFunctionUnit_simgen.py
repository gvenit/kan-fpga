...
def RadialBasisFunctionUnit():
    return verilog.from_verilog.read_verilog_module(
        os.path.join(TOP_DIR,'rtl/wrapper/RadialBasisFunctionUnitWrapper.v')
    )['RadialBasisFunctionUnitWrapper'] 

def tb_RadialBasisFunctionUnit():
    module = Module('tb_RadialBasisFunctionUnit')

    RSWAFF = RadialBasisFunctionUnit()
    ...
    vcd_name = os.path.join('..','vcd','tb_RadialBasisFunctionUnit.vcd')
...
def main():
    ...
    # fname = os.path.join(TOP_DIR,'rtl/RadialBasisFunctionUnit.v')
    # verilog = module.to_verilog(fname)
    # stripModule(fname, 'RadialBasisFunctionUnit')
    # addTimeScale(fname)
    
    test = tb_RadialBasisFunctionUnit()
    fname = os.path.join(TOP_DIR,'tb/tb_RadialBasisFunctionUnit.v')
