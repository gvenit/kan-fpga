...
def tb_AxisSplitter():
    ...
    axisSplitter = AxisSplitter()
    params = module.copy_params_as_localparams(axisSplitter)
    ports  = module.copy_ports_as_vars(axisSplitter)
...
def main():
    ...
    # module = AxisSplitter()
    # fname = os.path.join(TOP_DIR,'rtl/AxisSplitter.v')
    # verilog = module.to_verilog(fname)
    # stripModule(fname, 'AxisSplitter')
    # addTimeScale(fname)
