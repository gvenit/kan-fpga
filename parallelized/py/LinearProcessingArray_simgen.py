...
def tb_LinearProcessingArray(I=1,J=1,K=1):
    module = Module(f'tb_LinearProcessingArray_{I}_{J}_{K}')

    lpa = LinearProcessingArray()
    ...
    vcd_name = os.path.join('..','vcd',f'tb_LinearProcessingArray_{I}_{J}_{K}.vcd')
...
def main():
    ...
    for I,J,K in (
        ...
        test = tb_LinearProcessingArray(I=I,J=J,K=K)
        fname_base = f'tb_LinearProcessingArray_{I}_{J}_{K}'
