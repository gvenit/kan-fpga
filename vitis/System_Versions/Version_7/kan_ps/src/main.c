...
#define OPERATION_DONE_VAL 0x00 // !!!!!!!
...
void dbg_print_pl_status_regs(void)
{
    ...
    else
    {
        ...
        {
        case CTRL_REG_MASK_OPER_STS_IDL:
            xil_printf("Operation Idle\r\n");
            break;

        case CTRL_REG_MASK_OPER_STS_BSY:
            xil_printf("Operation Busy\r\n");
            break;

        case CTRL_REG_MASK_OPER_STS_ERR:
            xil_printf("Operation Error\r\n");
            break;

        case CTRL_REG_MASK_OPER_STS_LCK:
            xil_printf("Locked Core\r\n");
            break;

        case CTRL_REG_MASK_OPER_STS_VLD:
            xil_printf("Valid Configuration\r\n");
            break;

        case CTRL_REG_MASK_OPER_STS_RST:
            xil_printf("Core Reset\r\n");
            break;

        default:
            xil_printf("Unkown value %u\r\n", (unsigned int)reg_rd_val);
            break;
        }
    }
}
