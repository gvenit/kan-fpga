...
extern volatile int reg_status_valid_flag;  // 1 if core has valid config. Updated by the PL and user must zero it after a read
extern volatile int reg_status_reset_flag;  // 1 if core reset. Updated by the PL and user must zero it after a read
